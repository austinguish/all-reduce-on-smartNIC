...
#define DOCA_TELEMETRY_NETFLOW_FIELDS_NUM 23
...
extern struct doca_telemetry_netflow_flowset_field netflow_template_fields[DOCA_TELEMETRY_NETFLOW_FIELDS_NUM];

extern struct doca_telemetry_netflow_template netflow_template;
...
int init_netflow_schema_and_source(uint8_t id, char *source_tag);
